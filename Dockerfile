...
# Use a fast Go module proxy for China-based builders; harmless elsewhere.
...
RUN GOMAXPROCS=1 go build -p 1 -ldflags "-s -w -X 'github.com/QuantumNous/new-api/common.Version=$(cat VERSION)'" -o new-api
